...
const loginPhotoSlots = [
  ...
  { id: "nanjing", city: "南京", label: "金陵深秋", fallback: loginPhotoFallback("nanjing") },
        ...
        <div className="rounded-[8px] border border-[#D8DDD8]/78 bg-[#FAFBF7]/76 p-5 shadow-[0_12px_28px_rgba(90,102,112,0.06)] md:col-span-2">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="grid gap-1.5">
              ...
              <span className="text-xs font-semibold text-[#5A6670]/48">进入密码（自己设置）</span>
        ...
        <div className="rounded-[8px] border border-[#D8DDD8]/78 bg-[#FAFBF7]/76 p-5 shadow-[0_12px_28px_rgba(90,102,112,0.06)] md:col-span-2">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-[#5A6670]/62">
              ...
              首页“logo”、“沿途天气”显示的城市，都可以在这里改成你自己的。
            ...
            <div className="mt-2 flex items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <label
                  ...
                  className={`cursor-pointer rounded-[7px] border border-[#D8DDD8] px-4 py-2 text-sm font-semibold text-[#5A6670]/72 transition hover:bg-white/60 ${isAdmin ? "" : "pointer-events-none opacity-50"
                  ...
                  <div className="mt-3 flex items-center justify-between gap-3">
                    ...
                    <div className="flex shrink-0 gap-2">
                      ...
                      <label
                        ...
                        className={`grid h-9 w-9 place-items-center rounded-[7px] border border-[#A8C8DC] text-[#A8C8DC] transition hover:bg-[#D6E8F0]/36 ${isWorking || !isAdmin ? "pointer-events-none opacity-45" : ""
